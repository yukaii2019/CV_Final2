...
# def write_result_log(logfile_path, epoch, epoch_time, train_loss,train_loss_1,train_loss_2, val_loss,val_loss_1,val_loss_2, is_better):
#     ''' write experiment log file for result of each epoch to ./experiment/{exp_name}/log/result_log.txt '''
#     with open(logfile_path, 'a') as f:
#         f.write(f'[{epoch + 1}/{cfg.epochs}] {epoch_time:.2f} sec(s)  Train Loss: {train_loss:.5f} | Train Loss1: {train_loss_1:.5f} | Train Loss2: {train_loss_2:.5f} | Val Loss: {val_loss:.5f} | Val Loss1: {val_loss_1:.5f} | Val Loss2: {val_loss_2:.5f}')
#         if is_better:
